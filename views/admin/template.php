<html hola_ext_inject="disabled"><head>
    <meta charset="UTF-8">
     <title>+++</title>
    <!---!>
     <!--- TODO MOVE EVERY ASSETS TO THE THEME FOLDER  -->
    ...
    <link rel="stylesheet" href="views/js/esteinborn-jquery-listnav-389adda/css/listnav.css">

    <!-- Main Custom Style sheet -->
    <link href="theme/dist/css/main_custom.css" rel="stylesheet" type="text/css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link href="theme/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" media="all" href="views/js/mini-upload-form/assets/css/uploadform.css"/>
    <link rel="stylesheet" type="text/css" media="all" href="views/css/instantsearch.css"/>
    <link rel="stylesheet" type="text/css" media="all" href="views/css/jquery-ui.css"/>
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="http://176.31.245.123/stansmith/index.php?controller=admin" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>S
          </b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Stan</b>SMITH</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <!-- Navbar Right Menu -->
            ...
            <div class="navbar-custom-menu">
              <a href="http://176.31.245.123/stansmith/?controller=x" target="blank"> Aller sur le site </a> 
            </div>
        </nav>
      </header>
   ...
   <!--    <footer class="main-footer">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="theme/plugins/jQuery/jQuery-2.1.4.min.js" type="text/javascript"></script>
       <!-- jQuery UI 1.11.2 -->
    ...
    <!-- <script src="theme/dist/js/pages/dashboard2.js" type="text/javascript"></script> -->

    <!-- AdminLTE for demo purposes -->
    <script src="theme/dist/js/demo.js" type="text/javascript"></script>

<script src="views/js/mini-upload-form/assets/js/jquery.knob.js"></script>
<script src="views/js/mini-upload-form/assets/js/jquery.ui.widget.js"></script>
<script src="views/js/mini-upload-form/assets/js/jquery.iframe-transport.js"></script>
<script src="views/js/mini-upload-form/assets/js/jquery.fileupload.js"></script>
<script src="views/js/mini-upload-form/assets/js/import.js"></script>
<script src="views/js/esteinborn-jquery-listnav-389adda/jquery-listnav.min.js"></script>
<script src="views/js/mini-upload-form/assets/js/instantsearch.js"></script>
<script src="views/js/ajaxhandler.js"></script>

<script src="theme/dist/js/main_custom.js" type="text/javascript"></script>
<script src="theme/dist/js/IM.js" type="text/javascript"></script>
